...
def main():
    ...
    checkpoint_path = "resnet50_galaxy3_checkpoint.pth"
    ...
    for epoch in range(start_epoch, start_epoch + 10):
        ...
        torch.save({
            ...
            "best_acc": best_acc
        }, "resnet50_galaxy3_checkpoint.pth")
        ...
        if accuracy > best_acc:
            best_acc = accuracy
            torch.save(model.state_dict(), "resnet50_galaxy3_best.pth")
            print("New best model saved with accuracy: {:.2f}%".format(best_acc))
    
    torch.save(model.state_dict(), "resnet50_galaxy3.pth")
